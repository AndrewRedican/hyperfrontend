...
| #   | Plan                                                               | Scope                                                             | Notes                                                       |
| --- | ------------------------------------------------------------------ | ----------------------------------------------------------------- | ----------------------------------------------------------- |
| 01  | [Reposition & Publishability](01-reposition-and-publishability.md) | Move `plugins/features` → `libs/features`; promote to publishable | **Foundation. Do first.** Same package, converted identity. |
| 02  | [CLI/bin Execution Research](02-cli-bin-execution.md)              | Confirm `@hyperfrontend/builder` bins run under every PM          | **Parallel** with 01/03; gates shipping a working CLI (05). |
