...
| F-014 | [Declaring only the display mode my feature actually has makes `hf build` emit code that cannot compile](014-single-display-mode-shell-fails-to-compile.md)               | packaging       | high     | demo-koi-fish-\* | open   | —           |
