...
**Depends on** [04](04-demo-1-clock.md) · **Type** D+E · **Status**: Pending — not yet elaborated.
...
- **The generator** (`tools/`, workspace-only): scaffolds a demo **composition** — host + N hostees, chosen frameworks, contract, `feature.config.*`, deploy + gallery-registration wiring — from the blank prototype extracted in [04](04-demo-1-clock.md).
