/**
 * The imperative side of the Angular koi: one 3D fish drawn through the shared
 * pond view, sixty times a second.
 *
 * Change detection is the wrong tool at that cadence, so nothing here is a
 ...
 *
 * @param canvas - The canvas Angular mounted for the koi.
