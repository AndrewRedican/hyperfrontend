/**
 * The imperative side of the Preact koi: one 3D fish drawn through the shared
 * pond view, sixty times a second.
 *
 * Preact's diff is the wrong tool at that cadence, so nothing here is a
 ...
 *
 * @param canvas - The canvas Preact mounted for the koi.
