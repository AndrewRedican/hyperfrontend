/**
 * Host integration for the "@hyperfrontend/demo-koi-fish-solid" feature.
 *
 ...
 * emitted ones.
 *
 * @module @hyperfrontend/demo-koi-fish-solid.feature
 */
...
export const feature = createFeature({
  name: '@hyperfrontend/demo-koi-fish-solid',
