/**
 * The imperative side of the Solid koi: one 3D fish drawn through the shared
 * pond view, sixty times a second.
 *
 * Even Solid's fine-grained reactivity is the wrong tool at that cadence, so
 * nothing here is a component. The koi component owns the canvas node and its
 ...
 *
 * @param canvas - The canvas Solid mounted for the koi.
