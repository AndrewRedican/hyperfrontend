...
describe('createKoiRenderer', () => {
  ...
  it('builds a transparent canvas and a hidden identity card', () => {
    createKoiRenderer(root, PROFILE, APP_URL, POND, () => gl)
    ...
    expect(site?.href).toContain('solidjs.com')
    ...
    expect(source?.href).toContain('fish-solid')
