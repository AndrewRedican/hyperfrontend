/**
 * The React koi: the canvas the 3D fish renders into, and its identity card.
 *
  ...
  return (
    <>
      ...
      <div className="koi-card" hidden ref={card}>
        <span className="koi-card-name">
          <span className="koi-card-title" style={{ color: profile.palette.accent }}>
            {profile.label}
          </span>
          ...
          <span className="koi-card-variety">{profile.palette.pattern}</span>
        </span>
        <span className="koi-card-line koi-card-state" ref={state} />
        ...
        <a className="koi-card-url" href={url} target="_blank" rel="noopener noreferrer" ref={app}>
          {url}
        </a>
        <span className="koi-card-line koi-card-runtime" ref={runtime} />
        <span className="koi-card-line koi-card-memory" ref={memory} />
