...
describe('createKoiRenderer', () => {
  ...
  it('builds a transparent canvas and a hidden identity card', () => {
    ...
    expect(site?.href).toContain('typescriptlang.org')
    ...
    expect(source?.href).toContain('fish-vanilla')
  ...
  it('slides the canvas with the koi instead of repainting the world', () => {
    ...
    const canvas = root.querySelector<HTMLElement>('canvas.koi-canvas') as HTMLElement
