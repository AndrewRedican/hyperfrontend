...
beforeEach(() => {
  ...
  // Use try-catch since some bundlers may create non-configurable properties
  try {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    if ((window as any).HyperfrontendLogging !== undefined) {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ;(window as any).HyperfrontendLogging = undefined
    }
  } catch {
