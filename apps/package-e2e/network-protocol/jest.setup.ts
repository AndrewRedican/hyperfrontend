...
beforeEach(() => {
  ...
  try {
    ...
    if ((window as any).HyperfrontendNetworkProtocolV1 !== undefined) {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ;(window as any).HyperfrontendNetworkProtocolV1 = undefined
    }
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    if ((window as any).HyperfrontendNetworkProtocolV2 !== undefined) {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ;(window as any).HyperfrontendNetworkProtocolV2 = undefined
    }
  } catch {
