...
You embed each app through its own shell package, generated by [`@hyperfrontend/features`](/docs/libraries/features) from the contract that app declares; inside, each app runs [`createFeature`](/docs/libraries/features/hostee#api-createFeature) from the same SDK. The snippets come from the [koi pond](https://demo-koi-pond-production.up.railway.app/), which composes eight apps in eight frameworks this way.
