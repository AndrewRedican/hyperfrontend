...
export async function generateMetadata({ params }: ArticlePageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      types: { ...ARTICLES_FEED_ALTERNATE, ...markdownAlternate(`/articles/${article.slug}`, article.title) },
    },
      ...
      <main id="main-content" className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 rail:max-w-6xl">
        <MarkdownDocPage
          ...
          descriptor={{
            ...
            title: article.title,
            subject: documentSubject('article', article.title),
            kind: 'article',
          }}
          // why: narrow article images do not fill the prose column, so they are centred rather than left aligned
          proseClassName="[&_img]:mx-auto"
          before={
            <>
