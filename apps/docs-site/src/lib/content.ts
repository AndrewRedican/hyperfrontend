...
export const LIBRARIES: LibraryInfo[] = [
  ...
  },
  {
    ...
    entryPoints: [
      ...
      'libs/features/src/nx/generators/index.ts',
      'libs/features/src/nx/generators/feature/index.ts',
      'libs/features/src/nx/generators/init/index.ts',
      'libs/features/src/nx/executors/index.ts',
      'libs/features/src/nx/executors/build/index.ts',
      'libs/features/src/nx/executors/serve/index.ts',
    ],
    category: 'core',
  },
]
