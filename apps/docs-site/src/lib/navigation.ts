...
const coreLibraries: NavItem[] = [
  ...
  { slug: 'network-protocol', packageName: '@hyperfrontend/network-protocol', href: '/docs/libraries/network-protocol' },
  { slug: 'project-scope', packageName: '@hyperfrontend/project-scope', href: '/docs/libraries/project-scope' },
]
...
const supportingLibraries: NavItem[] = [
  ...
  { slug: 'versioning', packageName: '@hyperfrontend/versioning', href: '/docs/libraries/versioning' },
