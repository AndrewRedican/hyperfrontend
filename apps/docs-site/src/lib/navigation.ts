...
const coreLibraries: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { slug: 'nx/generators', href: '/docs/libraries/features/nx/generators' },
      { slug: 'nx/generators/feature', href: '/docs/libraries/features/nx/generators/feature' },
      { slug: 'nx/generators/init', href: '/docs/libraries/features/nx/generators/init' },
      { slug: 'nx/executors', href: '/docs/libraries/features/nx/executors' },
    ...
    children: [
      { slug: 'architecture', href: '/docs/libraries/network-protocol/architecture' },
      {
        ...
        children: [
          ...
          { slug: 'v3', href: '/docs/libraries/network-protocol/browser/v3' },
          { slug: 'v4', href: '/docs/libraries/network-protocol/browser/v4' },
        ],
      },
      {
        slug: 'node',
        ...
        children: [
          ...
          { slug: 'v3', href: '/docs/libraries/network-protocol/node/v3' },
          { slug: 'v4', href: '/docs/libraries/network-protocol/node/v4' },
        ],
      },
