...
interface NavItemIconProps {
  /** Whether the entry is a published package or a nested submodule. */
  kind: NavIconKind
...
/**
 * Decorative icon shown next to package and submodule labels in the docs
 * navigation. Renders both theme variants and swaps them with the `.dark`
 * class (same `block dark:hidden` / `hidden dark:block` pattern as the logo),
 * so it stays correct without client-side theme detection.
 * @param root0 - The props object.
 * @param root0.kind - Whether the entry is a package or a submodule.
