/**
 * Integration Tests: Broker + Channel Communication
 *
 * Tests the complete end-to-end flow of broker and channel communication,
 * ensuring proper message routing, event notifications, and state transitions.
 */
