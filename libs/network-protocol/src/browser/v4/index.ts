/**
 * V4 protocol for the browser: the session envelope keyed by an ephemeral
 * P-256 agreement plus a stretched shared secret, so an outsider cannot join
 * and a key that leaks later cannot open past sessions.
 *
