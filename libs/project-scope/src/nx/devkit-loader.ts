 ...
 *
 * @example Loading devkit dynamically
 * ```typescript
 ...
 *
 * @example Checking devkit availability
 * ```typescript
 ...
 *
 * @example Getting the devkit module
 * ```typescript
 ...
 *
 * @example Using devkit with fallback
 * ```typescript
 ...
 * @internal
 *
 * @example Resetting devkit cache in tests
 * ```typescript
