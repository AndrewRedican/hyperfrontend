...
Locked, prototype-pollution-resistant copies of the global `ArrayBuffer`, `SharedArrayBuffer`, `DataView`, and [`TypedArray`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) constructors.
