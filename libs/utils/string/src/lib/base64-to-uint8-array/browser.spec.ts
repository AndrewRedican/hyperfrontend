...
import { utf8StringToUint8Array } from '../utf8-string-to-uint8-array/browser/utf8-string-to-uint8-array'
import { base64ToUint8Array } from './browser/base64-to-uint8-array'

describe('base64ToUint8Array (browser)', () => {
