    ...
    panels: [
      {
        ...
        rows: [
          ...
          { text: 'jobs.pull()', atMs: 2_200, typeMs: 320 },
          { text: '{ id: 1 }', atMs: 2_680, marker: '›', tone: 'accent' },
          { text: 'jobs.pull()', atMs: 3_180, typeMs: 300 },
          { text: '{ id: 2 }', atMs: 3_620, marker: '›', tone: 'accent' },
          { text: 'jobs.pull()', atMs: 4_120, typeMs: 300 },
          { text: '{ id: 3 }', atMs: 4_560, marker: '›', tone: 'accent' },
      ...
      },
      {
        ...
        rows: [
          ...
          { text: 'jobs.push({ id: 3 })', atMs: 1_360, typeMs: 420 },
          { text: 'jobs.pull()', atMs: 2_200, typeMs: 320 },
          { text: '{ id: 3 }', atMs: 2_680, marker: '›', tone: 'accent' },
          { text: 'jobs.pull()', atMs: 3_180, typeMs: 300 },
          { text: '{ id: 2 }', atMs: 3_620, marker: '›', tone: 'accent' },
          { text: 'jobs.pull()', atMs: 4_120, typeMs: 300 },
          { text: '{ id: 1 }', atMs: 4_560, marker: '›', tone: 'accent' },
          { text: 'jobs.push({ id: 1 })', atMs: 5_600, typeMs: 460 },
          { text: 'jobs.has({ id: 1 })', atMs: 6_300, typeMs: 440 },
          { text: 'false', atMs: 7_100, marker: '›', tone: 'warning', emphasis: true },
        ],
