...
export default defineRailway(() => {
  ...
  const koiVue = service('koi vue', {
    ...
    start: 'npx -y @hyperfrontend/features@0.8.0 serve --root dist/apps/demos/koi-pond/site/fish-vue --host 0.0.0.0 --port $PORT',
    healthcheck: '/',
  ...
  const koiPond = service('koi-pond', {
    ...
    start: 'npx -y @hyperfrontend/features@0.8.0 serve --root dist/apps/demos/koi-pond/site --host 0.0.0.0 --port $PORT',
    healthcheck: '/',
    replicas: { 'europe-west4-drams3a': 1 },
  })
  const heartbeat = service('heartbeat', {
    ...
    start: 'npx -y @hyperfrontend/features@0.8.0 serve --root dist/apps/demos/heartbeat/app --host 0.0.0.0 --port $PORT',
    healthcheck: '/',
    replicas: { 'europe-west4-drams3a': 1 },
  ...
  const koiAngular = service('koi-angular', {
    ...
    start: 'npx -y @hyperfrontend/features@0.8.0 serve --root dist/apps/demos/koi-pond/site/fish-angular --host 0.0.0.0 --port $PORT',
    healthcheck: '/',
    replicas: { 'europe-west4-drams3a': 1 },
  })
  const koiSolid = service('koi solid', {
    ...
    start: 'npx -y @hyperfrontend/features@0.8.0 serve --root dist/apps/demos/koi-pond/site/fish-solid --host 0.0.0.0 --port $PORT',
    healthcheck: '/',
    replicas: { 'europe-west4-drams3a': 1 },
  ...
  const koiLit = service('koi lit', {
    ...
    start: 'npx -y @hyperfrontend/features@0.8.0 serve --root dist/apps/demos/koi-pond/site/fish-lit --host 0.0.0.0 --port $PORT',
    healthcheck: '/',
    replicas: { 'europe-west4-drams3a': 1 },
  ...
  const koiPreact = service('koi-preact', {
    ...
    start: 'npx -y @hyperfrontend/features@0.8.0 serve --root dist/apps/demos/koi-pond/site/fish-preact --host 0.0.0.0 --port $PORT',
    healthcheck: '/',
    replicas: { 'europe-west4-drams3a': 1 },
  ...
  const clock = service('clock', {
    ...
    start: 'npx -y @hyperfrontend/features@0.8.0 serve --root dist/apps/demos/clock/app --host 0.0.0.0 --port $PORT',
    healthcheck: '/',
    replicas: { 'europe-west4-drams3a': 1 },
  ...
  const koiSvelte = service('koi svelte', {
    ...
    start: 'npx -y @hyperfrontend/features@0.8.0 serve --root dist/apps/demos/koi-pond/site/fish-svelte --host 0.0.0.0 --port $PORT',
    healthcheck: '/',
    replicas: { 'europe-west4-drams3a': 1 },
  ...
  const koiReact = service('koi react', {
    ...
    start: 'npx -y @hyperfrontend/features@0.8.0 serve --root dist/apps/demos/koi-pond/site/fish-react --host 0.0.0.0 --port $PORT',
    healthcheck: '/',
    replicas: { 'europe-west4-drams3a': 1 },
  ...
  const koiVanilla = service('koi-vanilla', {
    ...
    start: 'npx -y @hyperfrontend/features@0.8.0 serve --root dist/apps/demos/koi-pond/site/fish-vanilla --host 0.0.0.0 --port $PORT',
    healthcheck: '/',
    replicas: { 'europe-west4-drams3a': 1 },
  })
